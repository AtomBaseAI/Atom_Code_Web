            ...
            <div className="row">
              <div className="col-md-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                <div className="card contact-detail text-center border-0">
                  <div className="card-body p-0">
                    <div className="icon">
                      <img src="https://ik.imagekit.io/nodehive/hive/icon/Email.svg" className="avatar avatar-small" alt="hive" />
                    </div>
                    <div className="content mt-3">
                      ...
                      <Link href="mailto:info@atomcode.dev" className="text-indigo">info@atomcode.dev</Link>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* <div className="col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                <div className="card contact-detail text-center border-0">
                  <div className="card-body p-0">
                    <div className="icon">
                      <img src="https://ik.imagekit.io/nodehive/hive/icon/location.svg" className="avatar avatar-small" alt="hive" />
                    </div>
                    <div className="content mt-3">
            ...
            <div className="row align-items-center">
                      ...
                      <div className="col-6">
                        <div className="icon m-5">
                          <Link href="tel:+0424 3555195">
                            <img src="https://ik.imagekit.io/nodehive/hive/social/1.png" className="avatar avatar-small" alt="hive" />
                          </Link>
                        </div>
                        {/* <div className="icon m-5">
                          <Link href="https://www.facebook.com/nodehivecorp">
                            <img src="https://ik.imagekit.io/nodehive/hive/social/3.png" className="avatar avatar-small" alt="hive" />
                          </Link>
                        </div> */}
                      </div>
                      <div className="col-6">
                        <div className="icon m-5">
                          <Link href="mailto:info@atomcode.dev">
                            <img src="https://ik.imagekit.io/nodehive/hive/social/2.png" className="avatar avatar-small" alt="hive" />
                          </Link>
                        </div>
                        {/* <div className="icon m-5">
                          <Link href="https://www.instagram.com/nodehive/">
                            <img src="https://ik.imagekit.io/nodehive/hive/social/4.png" className="avatar avatar-small" alt="hive" />
                          </Link>
                        </div> */}
                      </div>
                    </div>
              ...
              <div className="col-lg-7 col-md-6 order-1 order-md-2">
                <div className="card border-0">
                  <div className="card-body p-0">
                    <img src="https://ik.imagekit.io/nodehive/hive/contact.svg" className="img-fluid" alt="hive" />
                  </div>
                </div>
              </div>
