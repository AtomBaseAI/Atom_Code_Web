      ...
      <div>
        ...
        <section className="section">
                  ...
                  <div className="col-lg-6 col-6 mt-4 mt-lg-0 pt-2 pt-lg-0">
                    <div className="card work-container work-modern overflow-hidden rounded border-0 shadow-md">
                      <div className="card-body p-0">
                        <img src="https://ik.imagekit.io/nodehive/hive/about/ab01.jpg" className="img-fluid" alt="work-image" />
                  ...
                  <div className="col-lg-6 col-6">
                    <div className="row">
                      <div className="col-lg-12 col-md-12 mt-4 mt-lg-0 pt-2 pt-lg-0">
                        <div className="card work-container work-modern overflow-hidden rounded border-0 shadow-md">
                          <div className="card-body p-0">
                            <img src="https://ik.imagekit.io/nodehive/hive/about/ab02.jpg" className="img-fluid" alt="work-image" />
                            <div className="overlay-work bg-dark" />
                            <div className="content">
                      ...
                      <div className="col-lg-12 col-md-12 mt-4 pt-2">
                        <div className="card work-container work-modern overflow-hidden rounded border-0 shadow-md">
                          <div className="card-body p-0">
                            <img src="https://ik.imagekit.io/nodehive/hive/about/ab03.jpg" className="img-fluid" alt="work-image" />
                            <div className="overlay-work bg-dark" />
                            <div className="content">
          ...
          {/* <div className="container-fluid mt-100 mt-60">
            <div className="rounded py-5" style={{ background: 'url("https://ik.imagekit.io/nodehive/hive/about/cta.jpg") center center' }}>
