        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-5 col-md-5 mt-4 pt-2 mt-sm-0 pt-sm-0">
              <img src="https://ik.imagekit.io/nodehive/hive/illustratorx/Startup_SVG_css.svg" alt="hive" />
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="row align-items-center">
              ...
              <div className="col-md-7 col-12 mt-4 pt-2">
                <Tab.Panels className="tab-content ml-lg-4">
                  <Tab.Panel>
                    <img src="https://ik.imagekit.io/nodehive/hive/task/1.jpg" className="img-fluid mx-auto rounded-md shadow-lg d-block" alt="hive" />
                  </Tab.Panel>
                  <Tab.Panel>
                    <img src="https://ik.imagekit.io/nodehive/hive/task/2.jpg" className="img-fluid mx-auto rounded-md shadow-lg d-block" alt="hive" />
                  </Tab.Panel>
                  <Tab.Panel>
                    <img src="https://ik.imagekit.io/nodehive/hive/task/3.jpg" className="img-fluid mx-auto rounded-md shadow-lg d-block" alt="hive" />
                  </Tab.Panel>
                  <Tab.Panel>
                    <img src="https://ik.imagekit.io/nodehive/hive/task/4.jpg" className="img-fluid mx-auto rounded-md shadow-lg d-block" alt="hive" />
                  </Tab.Panel>
                </Tab.Panels>
              </div>
            </div>
          ...
          <div className="row mt-4 pt-2 position-relative" id="counter" style={{ zIndex: 1 }}>
            <div className="col-md-3 col-6 mt-4 pt-2">
              <div className="counter-box text-center">
                <img src="https://ik.imagekit.io/nodehive/hive/illustrator/Asset190.svg" className="avatar avatar-small" alt="hive" />
            ...
            <div className="col-md-3 col-6 mt-4 pt-2">
              <div className="counter-box text-center">
                <img src="https://ik.imagekit.io/nodehive/hive/illustrator/Asset189.svg" className="avatar avatar-small" alt="hive" />
            ...
            <div className="col-md-3 col-6 mt-4 pt-2">
              <div className="counter-box text-center">
                <img src="https://ik.imagekit.io/nodehive/hive/illustrator/Asset192.svg" className="avatar avatar-small" alt="hive" />
            ...
            <div className="col-md-3 col-6 mt-4 pt-2">
              <div className="counter-box text-center">
                <img src="https://ik.imagekit.io/nodehive/hive/illustrator/Asset187.svg" className="avatar avatar-small" alt="hive" />
                <h2 className="mb-0 mt-4"><span className="counter-value" data-count={50}>50</span>+</h2>
