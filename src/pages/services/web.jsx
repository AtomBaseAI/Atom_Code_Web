            ...
            <div className="row justify-content-center">
              <div className="col-lg-12 text-center">
                <div className="page-next-level">
                  <h4 className="title">Web Services</h4>
            ...
            <div className="row">
              ...
              <div className="col-lg-4 col-md-6 mt-4 pt-2">
                <div className="media key-feature align-items-center p-3 rounded shadow">
                  ...
                  <div className="media-body">
                    <h4 className="title mb-0">Secured SSL</h4>
                  </div>
                </div>
              </div>  
              <div className="col-lg-4 col-md-6 mt-4 pt-2">
            ...
            <div className="row align-items-center">
              <div className="col-lg-7 col-md-6 order-2 order-md-1 mt-4 mt-sm-0 pt-2 pt-sm-0">
                <div className="section-title mr-lg-5">
                  <h4 className="title mb-4">How we build Web sites/applications incridible ?</h4>
                  <p className="text-muted">Our web team analyzie the requirment from clients, as per the requirment they choose the programming languages with latest and Long Term Support version which gives the highly scalable performance and user experience.</p>
                  <ul className="list-unstyled text-muted">
                    <li className="mb-0 py-1"><span className="text-indigo h5 mr-2"><CheckCircle /></span>Interactive UX with PHOTOSHOP &amp; ILLUSTRATOR</li>
                    <li className="mb-0 py-1"><span className="text-indigo h5 mr-2"><CheckCircle /></span>Responsible UI (mobile &amp; tablets) with BOOTSTRAP 5</li>
              ...
              <div className="col-lg-3 col-md-6 col-12 mt-4 pt-2 mt-lg-0 pt-lg-0">
                <div className="media align-items-center features">
                  ...
                  <div className="content ml-3">
                    <h5 className="mb-1"><Link href="#" className="text-dark">PHP/WORDPRESS</Link></h5>
                    <p className="text-muted mb-0">PHP-7.4 L.T.S &amp; WP-5.4</p>
                  </div>
                </div>
              </div>  
              <div className="col-lg-3 col-md-6 col-12 mt-4 pt-2 mt-lg-0 pt-lg-0">
                <div className="media align-items-center features">
                  ...
                  <div className="content ml-3">
                    <h5 className="mb-1"><Link href="#" className="text-dark">NODEJS</Link></h5>
                    <p className="text-muted mb-0">Nodejs-12.18 LTS</p>
                  </div>
                </div>
              </div>  
              <div className="col-lg-3 col-md-6 col-12 mt-4 pt-2 mt-lg-0 pt-lg-0">
                <div className="media align-items-center features">
                  ...
                  <div className="content ml-3">
                    <h5 className="mb-1"><Link href="#" className="text-dark">ANGULAR</Link></h5>
                    <p className="text-muted mb-0">Angular-10.1.3 LTS</p>
                  </div>
                </div>
              </div>  
              <div className="col-lg-3 col-md-6 col-12 mt-4 pt-2 mt-lg-0 pt-lg-0">
                <div className="media align-items-center features">
                  ...
                  <div className="content ml-3">
                    <h5 className="mb-1"><Link href="#" className="text-dark">REACTJS</Link></h5>
                    <p className="text-muted mb-0">Reactjs-16.13.1 LTS.</p>
                  </div>
                </div>
              </div>  
            </div>  
